...
export const FinanceApproverForm: React.FunctionComponent<IPurchaseRequisitionsProps> = (props: IPurchaseRequisitionsProps) => {
    ...
    //     return await EmployeeOps().getEmployeeMasterId(PurchaseRequisition.InitiatedById, props).then(results => {
    ...
    async function onRequestInitiate(formValues: any) {
       ...
       // await EmployeeOps().getEmployeeMasterId(props.currentSPContext.pageContext.legacyPageContext.userId, props).then(async (empResult) => {
            ...
            if (appMatrixResult.length <= 0) {
                ...
                let currLevl=PurchaseRequisition.NextApprovalLevel;
                let lastChar = currLevl.substr(currLevl.length - 1);
                //lastChar=parseInt(lastChar);
                let nxtLevl = parseFloat(lastChar) + 1;

                let firsttext = currLevl; 
                let result = firsttext.substr(0, 5);
                let finalresult = result+" "+nxtLevl;
                let nextApprovalMatrix: IDOAMatrix = appMatrixResult.filter((val) => val.Level === finalresult)[0];
                let Approverstatus='';let NextRole=0;let NextLevel=0;let NextApprover=0;let ApprovalHistory='';
                if(nextApprovalMatrix===undefined || nextApprovalMatrix===null)
                {
                    Approverstatus="Approved";
                    NextLevel=0;
                    NextRole=0;
                    NextApprover=0;
                    ApprovalHistory = 'Request has been Approved by ' + props.currentSPContext.pageContext.legacyPageContext.userDisplayName + ' on ' + new Date().toLocaleString('en-US') + '\n' + PurchaseRequisition.ApprovalHistory

                    
                }
                else{
                    Approverstatus="Pending";
                    NextLevel=nextApprovalMatrix.LevelId;
                    NextRole=nextApprovalMatrix.DesignationId;
                    NextApprover=nextApprovalMatrix.ApproverId;
            ...
            //    //return false;
               ...
               //await spCrudObj.updateData("PurchaseRequisitions", PRRequest, props).then(async (brrInsertResult) => {
                await spCrudObj.updateData("PurchaseRequisitions", PurchaseRequisition.Id,
                {
                    ...
                    ,'NextRoleId':NextRole
                    ,'NextApprovalLevelId':NextLevel
                    ,'NextApproversId':NextApprover
                    , 'ReportingManagerStatus':'Approved'
                    ...
                    <div className='py-2'>
                        ...
                        <h2 className={styles.subheading}>Requester Details</h2>
                            <div className="col-md-6">
                                <div>
                                   <label className='fw-bold'> Requester Name :-</label>
                                    </div>
                            ...
                            <div className="col-md-6">
                                <div>
                                <label className='fw-bold'>Department :-</label> </div>
                                <label id='lblDepartment' >{employeeDetail !== undefined ? employeeDetail.Department : ''}</label>
                            </div>
                            <div className="col-md-6">
                                <div>
                                <label className='fw-bold'>Employee ID :-</label> </div>
                        ...
                        <h2 className={styles.subheading + ' ' + styles.mrb}>PR Request Deatils</h2>
                            <div className='row'>
                                <div className='col-md-6'>
                                    <div>
                                    <label className='fw-bold'> Request Header :-</label></div>
                                    <div>
                                ...
                                <div className='col-md-6'>
                                    <div>
                                    <label className='fw-bold'>Request Description :- </label>
                                    </div>
                                        <div>
                                ...
                                <div className='col-md-6'>
                                    <div>
                                    <label className='fw-bold'>Request Date :-
                                    </label>
                                    </div>
                                    <div>
                                    {/* <label id='lblReqDate' >{PurchaseRequisition !== undefined ? PurchaseRequisition.RequestDate : ''}</label> */}
                                    <label id='lblReqDate' >{moment(new Date(PurchaseRequisition.RequestDate)).format('DD/MM/YYYY')}</label>
                                    </div>
                                </div>
                                <div className='col-md-6'>
                                    <div>
                                    <label className='fw-bold'>Request for :-</label>
                                    </div>
                                    <div>
                                    <label id='lblReqHeader' >{PurchaseRequisition !== undefined ? PurchaseRequisition.RequestHeader : ''}</label>
                                    </div>
                                ...
                                <div className='col-md-6'>
                                    <div>
                                    <label className='fw-bold'>On Behalf :-</label>
                                ...
                                <div className='col-md-6'>
                                    <div>
                                    <label className='fw-bold'>Request Number :-</label>
                                    </div>
                                    <div>
                                ...
                                <div className='col-md-6'>
                                    <div>
                                    <label className='fw-bold'>Company Name :-
                                    </label>
                                    </div>
                                    <div>
                                ...
                                <div className='col-md-6'>
                                    <div>
                                    <label className='fw-bold'>Vendor State/Site :-</label>
                                    </div>
                                    <div>
                                ...
                                <div className='col-md-6'>
                                    <div>
                                    <label className='fw-bold'>Vendor Address :-</label>
                                    </div>
                                    <div>
                                ...
                                <div className='col-md-6'>
                                    <div>
                                    <label className='fw-bold'>Delivery Location :-</label>
                                ...
                                <div className='col-md-6'>
                                    <div>
                                    <label className='fw-bold'>Vendor Estimate No :-</label>
                                    </div>
                                    <div>
                                ...
                                <div className='col-md-6'>
                                    <div className='form-group row mb-2'>
                                        <Label className='col-md-12 col-sm-12 fw-bold'>Attachments: </Label>
                        ...
                        <div className='row'>
                            <div className='col-md-6'>
                            <div className='col-md-12 p-0' style={{ fontWeight: '600'}}>Workflow History</div>
                        ...
                        <div style={{ marginTop: '50px' }}>
                            <Stack horizontal wrap tokens={{ childrenGap: 10, maxWidth: '100%', padding: '0px' }} style={{ width: '100%' }}>
                                <Stack.Item grow align='center' style={{ textAlign: 'center' }} tokens={{ padding: '0px', margin: '0px' }}>
                                    ...
                                    <PrimaryButton className={styles.btnprimary} type='submit' text="Submit"
                                        onClick={async () => {
                                    ...
                                    <Link to='/'>
                                        <PrimaryButton className={styles.btndefault} text="Cancel" iconProps={{ iconName: 'Cancel' }} />
                                    </Link>
                                </Stack.Item>
                            </Stack>
